        ...
        if(request()->ajax()){
            ...
            ->addColumn('acciones', function($data){
                ...
                $botones = '<div class="btn-group">
                            ...
                            <button class="btn btn-danger btn-sm eliminarRegistro" action="'.url()->current().'/'.$data->id_articulo.'" method="DELETE" token="'.csrf_token().'" pagina="articulos" style="margin-left: 5px;"> <i class="fas fa-trash-alt"></i></button>
